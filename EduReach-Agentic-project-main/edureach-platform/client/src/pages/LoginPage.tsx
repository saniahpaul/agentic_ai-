      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        <div className="absolute inset-0 bg-maroon/70 flex items-center justify-center">
          <div className="text-center text-white p-8">
            ...
            <h2 className="font-heading text-4xl font-bold mb-2">Mysore College</h2>
            <p className="text-white/80">Your Gateway to Smarter Education</p>
            <div className="mt-6 flex justify-center gap-3">
              <span className="px-3 py-1 bg-amber-400/20 border border-amber-400/30 rounded-full text-amber-300 text-xs">92% Placement</span>
              <span className="px-3 py-1 bg-amber-400/20 border border-amber-400/30 rounded-full text-amber-300 text-xs">150+ Faculty</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-cream">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500">Sign in to your Mysore College account</p>
          </div>
