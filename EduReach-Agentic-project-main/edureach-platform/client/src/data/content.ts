...
export const aboutContent = {
  title: "About Mysore College",
  subtitle: "Empowering Futures Since 2005",
  description:
    "Mysore College is a premier engineering and technology institution established in 2005, located in Mysore, Karnataka. Affiliated with VTU and approved by AICTE, New Delhi, our 25-acre campus features smart classrooms, advanced laboratories, and a central library with 50,000+ books.",
  highlights: [
...
export const contactInfo = {
  email: "admissions@mysorecollege.edu.in",
  phone: "+91-9876543210",
  general: "info@mysorecollege.edu.in",
